...
class ModelManager:
    ...
    def analyze_pose(self, video_path: str | Path) -> Dict[str, Any]:
        ...
        tracking = {
            ...
            "wrist_tracking_debug_csv": overlay_result.get("wrist_tracking_debug_csv"),
        }
        tracking.update(
            {
                ...
                "left_hand_tracking_rate": tracking["quality_metrics"].get("left_hand_tracking_rate"),
                "right_hand_tracking_rate": tracking["quality_metrics"].get("right_hand_tracking_rate"),
                "left_hand_confidence": tracking["quality_metrics"].get("left_hand_confidence"),
                "right_hand_confidence": tracking["quality_metrics"].get("right_hand_confidence"),
                "frames_with_missing_wrist_detection": tracking["quality_metrics"].get("frames_with_missing_wrist_detection"),
                "wrist_recovery_count": tracking["quality_metrics"].get("wrist_recovery_count"),
                "stale_hand_corrections": tracking["quality_metrics"].get("stale_hand_corrections"),
